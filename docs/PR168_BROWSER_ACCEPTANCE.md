...
- Project item trash currently has no UI restore action, and Canvas Undo intentionally excludes removed items. This existing limitation is not claimed as a passed restore flow.
