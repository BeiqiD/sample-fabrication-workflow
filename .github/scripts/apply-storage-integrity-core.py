...
Path("migrations/0024_blob_integrity_quarantine.sql").write_text(r'''PRAGMA foreign_keys = ON;
...
replace_once(
    "worker/blob-lifecycle/storage.ts",
...
Path("worker/blob-lifecycle/reuse.ts").write_text(r'''import type { Env } from "../types";
