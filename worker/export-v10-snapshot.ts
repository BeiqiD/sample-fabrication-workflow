import { FULL_EXPORT_ARCHIVE_SCHEMA, FULL_EXPORT_ARCHIVE_PROFILE, FULL_EXPORT_ARCHIVE_WRITER, type ExportTables, type FullExportManifestV10, type ObservedExportSchema } from "../shared/contracts/export";
import { projectCompatibilitySnapshot } from "../shared/contracts/export-compatibility";
import { createExportArtifact, validateFullExportV10, EXPORT_RETIRED_FIELDS_PATH, EXPORT_SOURCE_SCHEMA_PATH } from "../shared/contracts/export-protocol";
...
export async function snapshotFullExportV10(database: D1Database): Promise<FullExportManifestV10> {
