...
describe("complete export schema coverage", () => {
  ...
  it("covers every migrated application table and required view with the actual v9 snapshot", async () => {
    ...
    const snapshot = await snapshotFullExportV9(new SqliteD1Database(database) as unknown as D1Database);
