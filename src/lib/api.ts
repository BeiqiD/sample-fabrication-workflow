import type { FullExportManifestV15 } from "../../shared/contracts/export";
import type {
  TemplateRecord,
...
export const api = {
  ...
  getFullExport: () => request<FullExportManifestV15>("/exports/all?archiveSchema=15&archiveWriter=1"),
