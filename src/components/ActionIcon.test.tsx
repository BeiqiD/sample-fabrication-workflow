...
const names: ActionIconName[] = ["actions", "delete", "export", "metrology", "moon", "plan-update", "process", "split", "start", "sun", "plus", "chevron-down", "arrow-left", "undo", "redo", "more", "attachment", "pin", "save", "grip", "open", "inspector", "note", "link"];
